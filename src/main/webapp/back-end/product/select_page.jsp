...
<body bgcolor='white'>
	...
	<div>
		<ul>
			<li><a
				href='<%= request.getContextPath() %>/back-end/product/listAllProduct.jsp'>List</a>
				all Products. <br> <br>
			</li>
			...
			<li>
				<FORM METHOD="post"
					...
					<b>輸入商品編號:</b> <input type="text" name="product_id"> 
			...
			<jsp:useBean id="productSvc" scope="page"
				class="com.babymate.product.model.ProductService" />
